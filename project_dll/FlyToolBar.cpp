// FlyToolBar.cpp : implementation file   
//   
...
/////////////////////////////////////////////////////////////////////////////   
// CFlyToolBar   
IMPLEMENT_DYNAMIC(CFlyToolBar,CToolBar)   
   
BEGIN_MESSAGE_MAP(CFlyToolBar, CToolBar)   
//{{AFX_MSG_MAP(CFlyToolBar)   
ON_WM_ERASEBKGND()   
...
/////////////////////////////////////////////////////////////////////////////   
// CFlyToolBar message handlers   
   
void CFlyToolBar::EraseNonClient()   
{   
...
BOOL CFlyToolBar::OnEraseBkgnd(CDC *pDC)   
{   
...
void CFlyToolBar::OnWindowPosChanging(WINDOWPOS FAR* lpwndpos)    
{   
...
void CFlyToolBar::RepaintBackground()   
{   
...
void CFlyToolBar::DrawSeparators()   
{   
...
// Draw the separators   
void CFlyToolBar::DrawSeparators(CClientDC* pDC)   
{   
...
void CFlyToolBar::DrawGripper(CWindowDC *pDC, CRect& rectWindow)   
{   
...
void CFlyToolBar::SetBKColor(COLORREF color)   
{   
...
void CFlyToolBar::SetBKImage(UINT nIDResource)   
{   
    CBitmap tmp;   
...
void CFlyToolBar::SetBKImage(LPCTSTR lpszResourceName)   
{   
    CBitmap tmp;   
...
BOOL CFlyToolBar::LoadToolBar(UINT nIDResource)   
{   
...
BOOL CFlyToolBar::LoadBitmap(LPCTSTR lpszResourceName)   
{   
    ASSERT_VALID(this);   
    ASSERT(lpszResourceName != NULL);   
...
BOOL CFlyToolBar::SetButtonEx(UINT nIDResource)   
{   
    LPCTSTR lpszResourceName=MAKEINTRESOURCE(nIDResource);   
    return SetButtonEx(lpszResourceName);   
}   

BOOL CFlyToolBar::SetButtonEx(LPCTSTR lpszResourceName)   
{   
    CClientDC rdc(this);   
    CDC dc1,dc2,dc3,dc4;   
...
void CFlyToolBar::MouseHover(POINT pt)   
{   
    if (m_dwStyle & CBRS_FLOATING) {   
        // no grippers   
    } else if (m_dwStyle & CBRS_ORIENT_HORZ) {   
...
BOOL CFlyToolBar::PreTranslateMessage(MSG* pMsg)   
{   
    switch(pMsg->message)   
    {   
    case WM_MOUSEMOVE:   
...
void CFlyToolBar::OnBarStyleChange(DWORD dwOldStyle, DWORD dwNewStyle)   
{   
    //return;   
